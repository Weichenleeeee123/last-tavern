...
var RATE_LIMIT_MAX_REQUESTS = 15;
...
async function checkRateLimit(env, clientIP) {
  ...
  if (!globalScope.__rateLimitMap) {
    globalScope.__rateLimitMap = /* @__PURE__ */ new Map();
  }
...
var onRequestPost = /* @__PURE__ */ __name(async (context) => {
  ...
  if (!rateLimit.allowed) {
    const retryAfter = Math.ceil((rateLimit.resetAt - Date.now()) / 1e3);
    return new Response(
      JSON.stringify({
        error: "\u8BF7\u6C42\u8FC7\u4E8E\u9891\u7E41",
      ...
      }),
      {
        ...
        headers: {
          ...
          "X-RateLimit-Reset": String(Math.ceil(rateLimit.resetAt / 1e3))
        }
      }
    );
  }
  try {
    ...
    const response = await fetch(DEEPSEEK_ENDPOINT, {
      ...
      body: JSON.stringify({
        ...
        max_tokens: body.max_tokens ?? 8e3
      })
    });
    if (!response.ok) {
...
// ../.wrangler/tmp/pages-bYyqJc/functionsRoutes-0.896833517556642.mjs
var routes = [
  {
    routePath: "/api/chat",
    mountPath: "/api",
...
// ../../../../../../../../Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../../../../../Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
